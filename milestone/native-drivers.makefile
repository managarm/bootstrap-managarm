...
$f_gen := gen-drivers/libblockfs gen-drivers/libevbackend \
	gen-drivers/gfx/bochs gen-drivers/gfx/intel gen-drivers/gfx/virtio \
	gen-drivers/uart \
...
$f_all_progs := all-drivers/gfx/bochs all-drivers/gfx/intel install-drivers/gfx/virtio \
	all-drivers/uart \
	all-drivers/usb/hcds/uhci all-drivers/usb/hcds/ehci \
	all-drivers/usb/devices/hid all-drivers/usb/devices/storage \
	all-drivers/virtio
$f_install_progs := install-drivers/gfx/bochs install-drivers/gfx/intel install-drivers/gfx/virtio \
	install-drivers/uart \
