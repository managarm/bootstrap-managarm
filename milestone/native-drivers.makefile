...
$f_gen := gen-drivers/libblockfs gen-drivers/evbackend \
	gen-drivers/gfx/intel gen-drivers/uart \
	gen-drivers/usb/hcds/uhci gen-drivers/usb/hcds/ehci \
	gen-drivers/usb/devices/hid gen-drivers/usb/devices/storage \
	gen-drivers/virtio
$f_all_libs := all-drivers/libblockfs all-drivers/evbackend
$f_install_libs := install-drivers/libblockfs install-drivers/evbackend
$f_all_progs := all-drivers/gfx/intel all-drivers/uart \
	all-drivers/usb/hcds/uhci all-drivers/usb/hcds/ehci \
	all-drivers/usb/devices/hid all-drivers/usb/devices/storage \
	all-drivers/virtio
$f_install_progs := install-drivers/gfx/intel install-drivers/uart \
